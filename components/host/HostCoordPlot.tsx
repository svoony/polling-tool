      ...
      <div className="max-w-sm w-full">
        ...
        <div className="flex gap-3 items-stretch">
          ...
          <div className="flex flex-col justify-between shrink-0 w-16 text-right">
            <span className="text-zinc-400 text-sm leading-tight break-words">{yHigh}</span>
            <span className="text-zinc-400 text-sm leading-tight break-words">{yLow}</span>
          </div>

          {/* SVG Plot */}
          <div className="flex-1 border border-zinc-700 rounded-xl overflow-hidden" style={{ aspectRatio: '1 / 1' }}>
        ...
        <div className="flex gap-3 mt-1">
          ...
          <div className="flex-1 flex justify-between">
            <span className="text-zinc-400 text-sm leading-tight">{xLow}</span>
            <span className="text-zinc-400 text-sm leading-tight text-right">{xHigh}</span>
          </div>
        </div>
